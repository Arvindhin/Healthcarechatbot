...
#        master.minsize(700,350)
    ...
    def createWidget(self):
        self.lblQuestion=Label(self,text="Question",width=12,bg="pink")
        self.lblQuestion.grid(row=0,column=0,rowspan=4)

        self.lblDigonosis = Label(self, text="Digonosis",width=12,bg="blue")
        ...
        self.btnNo=Button(self,text="No",width=12,bg="green", command=self.btnNo_Click)
        self.btnNo.grid(row=25,column=0)
        self.btnYes = Button(self, text="Yes",width=12,bg="red", command=self.btnYes_Click)
        self.btnYes.grid(row=25, column=1,columnspan=20,sticky="e")

        self.btnClear = Button(self, text="Clear",width=12,bg="red", command=self.btnClear_Click)
        self.btnClear.grid(row=27, column=0)
        self.btnStart = Button(self, text="Start",width=12,bg="green", command=self.btnStart_Click)
...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Health Care Chatbot", bg="blue", width="300", height="3", font=("Calibri", 13))
        self.lblMsg.pack()
        
        
        self.btnLogin=Button(self, text="Login", height="2",bg="red", width="300", command = self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register", height="2",bg="green", width="300", command = self.btnRegister_Click)
